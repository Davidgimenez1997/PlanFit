...
public class SportDetailsFavoriteDialogPresenter implements GetSportFavorite {

    private SportDetailsFavoriteDialogView view;
    private DefaultSport sportFavorite;

    public SportDetailsFavoriteDialogPresenter(SportDetailsFavoriteDialogView view) {
        this.view = view;
