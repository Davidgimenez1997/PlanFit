...
public class NutritionSlimmingFragment extends BaseFragment
    ...
    private List<NutritionSlimming> nutritionCache;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(UtilsNetwork.checkConnectionInternetDevice(getContext())){
            showLoading();
            this.nutritionCache = SharedPreferencesManager.loadNutritionSlimming(getContext(), SharedPreferencesManager.NUTRITION_SLIMING_TAG);
    ...
    private void configureRecycleView (List<NutritionSlimming> data) {
    ...
    public void getSlimmingNutritions(boolean status, List<NutritionSlimming> data) {
        if(status){
            ...
            SharedPreferencesManager.saveNutritionSlimming(data, getContext(), SharedPreferencesManager.NUTRITION_SLIMING_TAG);
