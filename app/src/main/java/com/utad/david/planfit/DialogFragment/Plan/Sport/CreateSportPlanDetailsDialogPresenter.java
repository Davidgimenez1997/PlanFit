...
public class CreateSportPlanDetailsDialogPresenter implements GetSportPlan {

    private CreateSportPlanDetailsDialogView view;
    private DefaultSport sportFavorite;
    private ArrayAdapter spinnerArrayAdapter;

    public CreateSportPlanDetailsDialogPresenter(CreateSportPlanDetailsDialogView view) {
        this.view = view;
    ...
    public void deletePlan() {
        SportPlanRepository.getInstance().deleteSportPlan(this.sportFavorite.getName());
    }
