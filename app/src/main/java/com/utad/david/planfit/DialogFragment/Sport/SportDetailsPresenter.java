...
public class SportDetailsPresenter implements GetSportFavorite {

    private DefaultSport item;
    private int mode;
    private SportDetailsView view;

    public SportDetailsPresenter(DefaultSport item, int mode, SportDetailsView view) {
        this.item = item;
        this.mode = mode;
        this.view = view;
